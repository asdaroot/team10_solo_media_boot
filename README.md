...
Туториал представляет собой простой телеграмм-бот взаимодействующий с LLM, помогающий решать различные задачи специалистам Data Science, поддерживающий анализ информации в различных форматах.
